  ...
  const handleAIFill = () => {
      ...
      template.sections.forEach(section => {
          section.fields.forEach(field => {
              if ((field.type === 'textarea' || field.type === 'text') && !newValues[field.id]) {
                  newValues[field.id] = `[AI自动生成] 基于系统数据分析，该员工在${field.label}方面表现...`;
              }
          });
      });
                  ...
                  <div className="flex items-center justify-between mb-2">
                      ...
                      {!readOnly && (
                           <button
                                ...
                                className="flex items-center px-3 py-1.5 bg-gradient-to-r from-purple-50 to-indigo-50 text-purple-700 rounded-lg hover:from-purple-100 hover:to-indigo-100 transition-all border border-purple-100 shadow-sm text-xs font-bold"
                            >
