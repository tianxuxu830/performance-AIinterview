          ...
          return (
              <div className="flex items-center justify-end space-x-2">
                  ...
                  <button 
                      ...
                      className="text-primary hover:text-primary-700 font-medium text-xs px-2 py-1 rounded hover:bg-primary-50 transition-colors whitespace-nowrap"
                  >
                      预约会议
                  </button>
                  <button 
                      onClick={() => onDirectFeedback(session)}
                      className="text-gray-500 hover:text-primary-600 text-xs px-2 py-1 rounded hover:bg-gray-100 transition-colors whitespace-nowrap"
                  >
                      直接反馈
                  </button>
                  <button className="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded transition-colors" title="编辑信息">
                      <Edit3 size={14} />
                  </button>
              </div>
          );
          ...
          return (
               <div className="flex justify-end">
                <button 
                    ...
                    className="text-blue-600 hover:text-blue-800 font-medium text-xs px-3 py-1.5 bg-blue-50 rounded hover:bg-blue-100 transition-colors whitespace-nowrap flex items-center"
                >
                    查看详情
                </button>
               </div>
      ...
      if (isPendingConfirmation) {
          return (
              <div className="flex items-center justify-end space-x-2">
                  ...
                  <button 
                      className="text-green-600 hover:text-green-700 text-xs font-medium px-2 py-1 rounded hover:bg-green-50 transition-colors whitespace-nowrap"
                      onClick={() => alert('已代确认')}
                  >
                      直接确认
                  </button>
                  ...
                  <button 
                    onClick={() => onSelectSession(session)}
                    className="text-gray-500 hover:text-gray-800 font-medium text-xs px-2 py-1 rounded hover:bg-gray-100 transition-colors whitespace-nowrap"
                >
                    详情
                </button>
              </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead className="bg-gray-50 sticky top-0 z-10">
              <tr className="text-xs font-bold text-gray-500 uppercase tracking-wide">
                ...
                <th className="px-4 py-3 border-b border-gray-200 text-center">累计面谈</th>
                <th className="px-4 py-3 border-b border-gray-200 text-right min-w-[200px]">操作</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100 bg-white">
              {filteredSessions.map((session) => {
                  const historyCount = MOCK_HISTORY_RECORDS[session.employeeId]?.length || 0;
                    ...
                    <tr key={session.id} className="hover:bg-primary-50/30 transition-colors group text-sm relative">
                      ...
                      <td className="px-4 py-3">
                          <div className="flex items-center">
                              <div className="w-8 h-8 rounded-full bg-gray-100 text-gray-500 flex items-center justify-center text-xs mr-3 font-bold border border-white shadow-sm">
                      ...
                      <td className="px-4 py-3 text-center">
                          <button 
                            ...
                            className="inline-flex items-center justify-center px-2 py-1 rounded hover:bg-gray-100 text-gray-600 font-medium transition-colors border border-transparent hover:border-gray-200"
                          >
                              {historyCount} <History size={12} className="ml-1 text-gray-400" />
                          </button>
                      </td>
