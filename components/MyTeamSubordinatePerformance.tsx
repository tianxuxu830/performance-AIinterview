...
const MyTeamSubordinatePerformance: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 relative">
      ...
      {isDetailDrawerOpen && (
          <div className="absolute inset-0 z-50 flex justify-end bg-black/20 backdrop-blur-[1px] transition-all">
              <div className="w-[800px] bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
                  <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50">
                      <div className="flex items-center">
                          ...
                          <span className="font-bold text-gray-800">{selectedEmployee?.name} - 本期考核详情</span>
                      </div>
                  ...
                  <div className="flex-1 overflow-hidden p-0">
                      <AssessmentDetailTable 
                        ...
                        period={selectedEmployee?.currentTask} 
                      />
                  </div>
              </div>
          </div>
